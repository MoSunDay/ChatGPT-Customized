...
export const FETCH_COMMIT_URL = `https://api.github.com/repos/${GITHUBID}/${REPO}/commits?per_page=1`;
export const FETCH_TAG_URL = `https://api.github.com/repos/${GITHUBID}/${REPO}/tags?per_page=1`;
